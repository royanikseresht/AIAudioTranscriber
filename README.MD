...
**v.0.0.1**
<p align = "center"><img src = "./assets/doc_assets/app.jpeg" height = 300 width = 450 alt = "AITranscriber Snapshot"></p>
...
**v.0.0.2** (Transcribing an English Song for SoundCloud)
